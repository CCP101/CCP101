...
---
### **Skills** 🔧 
![Skills](https://skillicons.dev/icons?i=docker,git,github,md,mongodb,mysql,powershell,raspberrypi,js,ts,gulp,nodejs,vue,php,bootstrap,html,linux,nginx,c,cpp,go,java,spring,vscode,visualstudio,idea,vim,ai,tensorflow,pytorch,py)
---
###  **Working** 📊
